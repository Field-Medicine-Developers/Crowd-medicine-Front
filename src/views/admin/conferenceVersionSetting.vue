<template>
  <conferenceVersionSelect @fetch-id="fetchSetting" />

  <div class="container mt-4 cb" dir="rtl" v-if="isSelectedVersion">
    <h2 class="text-center mb-4">
      اعدادت المؤتمر - {{ this.form.arabicTitle }}
    </h2>
    ...
    <div class="card">
      <div class="card-body">
        <form @submit.prevent="upDateSetting">
          ...
          <div class="row mt-3">
            <div class="col-md-4">
              ...
              <input
                ...
                class="form-control"
                placeholder="عنوان هيرو بالعربية"
          ...
          <!-- Arabic, English, Persian Hero Subtitles with QuillEditor -->
          <div class="row mt-3">
          ...
          <div class="row mt-4">
            <div class="col-md-4">
              <label for="arabicFooter" class="form-label"
                >الحقوق بالعربي</label
              >
              <input
                id="arabicFooter"
                type="text"
            ...
            <div class="col-md-4">
              <label for="persianFooter" class="form-label"
                >الحقوق بالفارسية</label
              >
              <input
                id="persianFooter"
                type="text"
          ...
          <div class="row mt-3">
            <div class="col-md-3">
              <label for="arabicAddress" class="form-label">العنوان </label>
              <input
                id="arabicAddress"
                type="text"
...
export default {
  ...
  methods: {
    async fetchSetting(item) {
      ...
      try {
        const response = await api.get(
          "ConferenceSetting/GetConferenceSettingById?id=" + item
        );
        ...
        this.form.arabicTitle = response.data.data.arabicTitle;
        this.form.englishTitle = response.data.data.englishTitle;
        this.form.persianTitle = response.data.data.persianTitle;
        this.form.arabicHeroTitle = response.data.data.arabicHeroTitle;
        this.form.englishHeroTitle = response.data.data.englishHeroTitle;
        this.form.persianHeroTitle = response.data.data.persianHeroTitle;
        this.form.arabicHeroSubTitle = response.data.data.arabicHeroSubTitle || "";
        this.form.englishHeroSubTitle = response.data.data.englishHeroSubTitle || "";
        this.form.persianHeroSubTitle = response.data.data.persianHeroSubTitle || "";
        this.form.arabicFooter = response.data.data.arabicFooter;
        this.form.englishFooter = response.data.data.englishFooter;
        this.form.persianFooter = response.data.data.persianFooter;
        this.form.location.arabicAddress = response.data.data.location.arabicAddress;
        this.form.location.englishAddress = response.data.data.location.englishAddress;
        this.form.location.persianAddress = response.data.data.location.persianAddress;
        this.form.location.arabicAddressDescription = response.data.data.location.arabicAddressDescription;
        this.form.location.englishAddressDescription = response.data.data.location.englishAddressDescription;
        this.form.location.persianAddressDescription = response.data.data.location.persianAddressDescription;
        this.form.location.latitude = response.data.data.location.latitude;
        this.form.location.longitude = response.data.data.location.longitude;
        this.form.logoFullUrl = response.data.data.logoFullUrl;
        this.form.heroVedioFullUrl = response.data.data.heroVedioFullUrl;
        this.form.conferenceVersionID = response.data.data.conferenceVersionID;
        this.form.arabicTerms = response.data.data.arabicTerms || "";
        this.form.englishTerms = response.data.data.englishTerms || "";
        this.form.persianTerms = response.data.data.persianTerms || "";
    ...
    async upDateSetting() {
      ...
      try {
        await api.post(
          "ConferenceSetting/AddOrUpdateConferenceSetting",
          formData,
          {
            headers: {
        ...
        this.fetchSetting(this.form.conferenceVersionID);
